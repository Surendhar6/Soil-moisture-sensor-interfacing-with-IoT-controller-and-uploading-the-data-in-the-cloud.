...
#### secrets.h
```
#define SECRET_SSID "Surendhar"    // replace MySSID with your WiFi network name
#define SECRET_PASS "izsfo_1305"  // replace MyPassword with your WiFi password

#define SECRET_CH_ID 2711832     // replace 0000000 with your channel number
#define SECRET_WRITE_APIKEY "XVAUD8QPONVNP2HN"   // replace XYZ with your channel write API Key

//#define echoPin 25
//#define trigPin 26
```
# CIRCUIT DIAGRAM:
![IMG-20241115-WA0007 1](https://github.com/user-attachments/assets/c2478faf-4215-43a7-b5ce-9766a2d1939e)

# OUTPUT:
![IMG-20241115-WA0006 1](https://github.com/user-attachments/assets/7d01c718-aded-4d5e-a180-2de9c22d8242)

![IMG-20241115-WA0012 1](https://github.com/user-attachments/assets/d958c60c-ef96-48dc-aa37-cffd45f35b4d)
